...
const PopularAnimeLinks = async () => {
  const popularAnime = await getPopularAnime(5); // Reduced from 20 to 5 for better performance
            ...
            <div className="rounded-xl sm:rounded-2xl bg-gradient-to-br from-background-secondary to-background-tertiary border border-primary-500/30 shadow-xl sm:shadow-2xl p-4 sm:p-8 md:p-12 lg:p-16 w-full text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg sm:text-xl text-text-secondary mb-4 sm:mb-6 max-w-3xl mx-auto px-2">
                  Descoperă o lume vastă de hentaiuri în română. De la cele mai noi lansări la clasice atemporale, {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')} îți oferă acces nelimitat la divertismentul tău preferat, cu o interfață modernă și ușor de utilizat.
                </p>
                <p className="text-base sm:text-lg text-text-muted mb-6 sm:mb-10 max-w-3xl mx-auto px-2">
                  Vizionează acum episoade complete, de înaltă calitate fără reclame intruzive. Cu actualizări zilnice și o comunitate dedicată, {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')} este destinația ta numărul unu pentru a viziona hentai online, oriunde și oricând.
                </p>
...
<section className="container mx-auto py-8 sm:py-16 px-4 max-w-8xl text-text-secondary">
        <div className="space-y-8 sm:space-y-16">
          <div>
            <h2 className="text-2xl sm:text-4xl font-bold text-text-primary mb-4 sm:mb-8 bg-gradient-to-r from-primary-300 via-text-primary to-primary-300 bg-clip-text text-transparent text-center">{(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')} - Destinația #1 pentru hentai online GRATUIT în România</h2>
            ...
            <p className="text-base sm:text-lg leading-relaxed">Însă nu toate site-urile sunt create la fel! Majoritatea sunt pline de reclame deranjante, linkuri false și conținut de calitate proastă. De aceea am creat {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')}.ro - pentru a fi CEL MAI BUN site de hentai gratuit din România pentru toți pasionații!</p>
          </div>

          <div>
            <h3 className="text-xl sm:text-2xl font-bold text-text-primary mb-4 sm:mb-6">1/ Ce face {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')}.ro special?</h3>
            <p className="text-base sm:text-lg leading-relaxed">{(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')}.ro este site-ul GRATUIT de streaming hentai unde poți viziona hentai, fără înregistrare, fără taxe ascunse, fără bătăi de cap!</p>
          </div>

          <div>
            <h3 className="text-xl sm:text-2xl font-bold text-text-primary mb-4 sm:mb-6">2/ Este {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')}.ro 100% sigur?</h3>
          ...
          <div>
            <h3 className="text-xl sm:text-2xl font-bold text-text-primary mb-4 sm:mb-6">3/ De ce {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')}.ro este CEL MAI BUN site pentru hentai online gratuit?</h3>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-text-secondary text-sm sm:text-base">ZERO reclame periculoase, ZERO pop-up-uri enervante! {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')}.ro este cel mai sigur site de hentai din România.</p>
                </div>
              </li>
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-text-secondary text-sm sm:text-base">Full HD 1080p pentru o experiență cinematografică! Internetul lent? Nu-i problemă - alege între 360p, 720p sau 1080p. {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')}.ro se adaptează perfect la conexiunea ta!</p>
                </div>
              </li>
              <li className="flex items-start gap-2 sm:gap-3">
                <span className="text-secondary-400 mt-1">•</span>
                <div>
                  ...
                  <p className="text-text-secondary text-sm sm:text-base">Uită de încărcarea lentă! Pe {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')}.ro, hentai-ul tău favorit pornește INSTANT! Plus, poți descărca episoadele pentru vizionare offline!</p>
                </div>
              </li>
              <li className="flex items-start gap-2 sm:gap-3">
                <span className="text-secondary-400 mt-1">•</span>
              ...
              <li className="flex items-start gap-2 sm:gap-3">
                ...
                <div>
                  ...
                  <p className="text-text-secondary text-sm sm:text-base">Pe telefon, tabletă sau computer - {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')}.ro merge perfect pe TOATE dispozitivele! Poți continua episodul de pe telefon direct pe laptop!</p>
                </div>
              </li>
              <li className="flex items-start gap-2 sm:gap-3">
                <span className="text-secondary-400 mt-1">•</span>
            ...
            <div className="mt-8 sm:mt-12 text-center">
              <p className="text-lg sm:text-xl mb-4">Dacă vrei cel mai bun site de hentai din România, {(process.env.NEXT_PUBLIC_SITE_NAME || 'HentaiTerra')}.ro este alegerea PERFECTĂ! Încearcă ACUM și vei înțelege de ce suntem #1! Salvează site-ul în favorite și spune-le și prietenilor!</p>
